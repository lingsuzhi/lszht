    ...
    <div class="layui-colla-item">
        <p class="layui-colla-title">
				<span id="menutreeclickdetailid"
                      class="layui-badge-rim layui-bg-green">商品单位</span>列表
        </p>
...
<script type="text/html" id="opeartion">
	...
	<script type="text/javascript"
		src="${ctx}/js/lsz/ProductCompany_m.js"></script>
	<script>
...
{field : 'sort', title : '排序' },
{templet : '<div>{{  qyjy(d.status) }}</div>', title : '状态' },
