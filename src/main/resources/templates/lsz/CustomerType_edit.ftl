...
<form class="layui-form" action="" id="linkForm"
 ...
 <div class="layui-form-item"><label class="layui-form-label">名称</label><div class="layui-input-block"> <input type="text" name="name"   class="layui-input" value="${(obj.name)!}"></div></div>
    ...
    <div class="layui-form-item"><label class="layui-form-label">类型</label><div class="layui-input-block"> <input type="text" name="type"   class="layui-input" value="${(obj.type)!}"></div></div>
<div class="layui-form-item"><label class="layui-form-label">排序</label><div class="layui-input-block"> <input type="text" name="sort"   class="layui-input" value="${(obj.sort)!}"></div></div>
   <div class="layui-form-item">
...
</div><div class="layui-form-item"><label class="layui-form-label">备注</label><div class="layui-input-block"> <input type="text" name="remark"   class="layui-input" value="${(obj.remark)!}"></div></div>
...
<script>
    $(function() {
        ...
        $("#parentDo").click(function(){
            ...
            $.get("customerTypeById.php?id=" + id,function(data){
                if(data.code==2000){
                    var bo = data.data;
